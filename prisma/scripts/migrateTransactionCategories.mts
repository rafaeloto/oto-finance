import { ExpenseTransactionCategory, GainTransactionCategory, InvestmentTransactionCategory, PrismaClient, TransactionType, TransferTransactionCategory } from '@prisma/client';
...
const gainMap: Record<GainTransactionCategory, string> = {
...
const expenseMap: Record<ExpenseTransactionCategory, string> = {
...
const investmentMap: Record<InvestmentTransactionCategory, string> = {
...
const transferMap: Record<TransferTransactionCategory, string> = {
